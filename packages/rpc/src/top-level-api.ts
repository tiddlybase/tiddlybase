...
export interface TopLevelAPIForSandboxedWiki extends ParentAPIBase<ChildInitProps>, WritableTiddlerDataSource, FileDataSource, AuthAPI, BackendFunctions, TopLevelUIAPI {}
